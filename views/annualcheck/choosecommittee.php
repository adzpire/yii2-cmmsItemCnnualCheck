...
<div class="invt-checkcommit-index">
    ...
    <?= GridView::widget([
		...
		'panel'=>[
            ...
            'before'=> '<h4 class="text-danger">ยังมีอุปกรณ์ที่ไม่จับคู่กับกรรมการ ในการตรวจปี '.$searchModel->year.'('.($searchModel->year+543).') จำนวน '.$dataProvider2->getTotalCount().' ชิ้น</h4>',
