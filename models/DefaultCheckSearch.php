 ...
 */
class DefaultCheckSearch extends InvtCheck
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        if(isset($committee)){
            $query->andWhere(['cc_id'=> $committee ]);
        }else{
            $query->andWhere(['cc_id'=> 0 ]);
        }
        //$query->andWhere(['invt_checkcommit.year'=> InvtCheckcommit::getIacyear()]);
        //$query->andWhere(['cc_id'=> 0]);
