 ...
 */
class StaffChangeSearch extends InvtCheck
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['old_occupy','occupy_by', 'note'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andWhere(' old_stat != stat_id or old_loc != loc_id or old_occupy not like occupy_by ');
